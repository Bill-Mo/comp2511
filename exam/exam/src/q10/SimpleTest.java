...
import q10.Column.ColumnType;

public class SimpleTest {
    public static void main(String[] args) {
        // you can uncomment/comment these to run as you go!
        // these tests are reasonably high coverage but they don't cover all
        // edge cases so you should add your own tests if you get time
        SimpleTestPartA();
        SimpleTestPartB();
        SimpleTestPartC();
        SimpleTestPartD();
    ...
    public static void SimpleTestPartD() {
        ...
        // now we are going to try to change the data and we would expect the cols to update
        // I recommend writing your tests like this rather than using raw files.
        db.ingest(
            // header
            "StudentId|Tutorial|GroupSuffix|Assignment|Lab1|Lab2\n" +
            "z1234    |tue15a  |pineapple  |          |    | \n" +
            "z2345    |        |           |          |0   |2"
            // make sure you don't end the last line with a `\n`
        );
